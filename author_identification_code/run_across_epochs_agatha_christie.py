...
#    hemingway_path_results = "/mnt/c/Users/kikibox/Documents/NLP/language-style-transfer/results/shakespeare_150/tmp_shakespeare_hemingway_150_epochs/sentiment.test.epoch"+str(i)+".0.tsf"
    ...
    hemingway_path_results = "/mnt/c/Users/kikibox/Documents/NLP/language-style-transfer/results/christie_dickens_not_full_sentence_14_epochs/tmp/sentiment.test.epoch"+str(i)+".0.tsf"
    ...
    shakespeare_path_results = "/mnt/c/Users/kikibox/Documents/NLP/language-style-transfer/results/christie_dickens_not_full_sentence_14_epochs/tmp/sentiment.test.epoch"+str(i)+".1.tsf"
...
df_results.to_csv("dickens_christie_f1_score_overtime.csv")
