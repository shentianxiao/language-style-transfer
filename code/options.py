...
def load_arguments():
    ...
    argparser.add_argument('--online_testing', type=bool, default=False)
    ...
    argparser.add_argument('--steps_per_checkpoint', type=int, default=1000)
    argparser.add_argument('--max_seq_length', type=int, default=20)
    argparser.add_argument('--max_train_size', type=int, default=-1)
    ...
    argparser.add_argument('--gamma_min', type=float, default=0.001)
    argparser.add_argument('--filter_sizes', type=str, default='3,4,5')
