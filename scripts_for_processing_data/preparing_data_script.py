...
file_path = "/mnt/c/Users/kikibox/Documents/NLP/language-style-transfer/code/creating_data_scripts/agatha_christie_one_file.txt"
...
with open('training_agatha_christie-v2.txt', 'w') as filehandle:
    for listitem in training_set:
        filehandle.write('%s\n' % listitem)


with open('testing_agatha_christie-v2.txt', 'w') as filehandle:
